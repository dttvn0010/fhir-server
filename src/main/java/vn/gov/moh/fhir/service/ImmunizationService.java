...
import vn.gov.moh.fhir.model.entity.ImmunizationEntity;
...
public class ImmunizationService {
    ...
    public List<ImmunizationEntity> search(String patientId, String encounterId, Integer offset, Integer count) {
        ...
        return mongoTemplate.find(query, ImmunizationEntity.class);                            
    }
}
